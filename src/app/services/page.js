    ...
    return (
        <div className="background">
            <div className="services">
                ...
                <div className="card">
                    <svg className="waveform" viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg">
                        <path d="M 0 160 
                     H 82 
                     C 88 160, 87 135, 93 135 
                     C 99 135, 97 185, 104 185 
                     C 111 185, 110 145, 116 145 
                     C 122 145, 122 175, 128 175
                     C 134 175, 134 125, 140 125
                     C 146 125, 147 215, 153 215
                     C 159 215, 156 70,  162 70
                     C 168 70,  167 245, 173 245
                     C 179 245, 178 140, 184 140
                     C 190 140, 190 90,  196 90
                     C 202 90,  201 210, 207 210
                     C 213 210, 213 120, 219 120
                     C 225 120, 224 180, 230 180
                     C 236 180, 235 135, 241 135
                     C 247 135, 246 160, 252 160 
                     H 320"
                            fill="none"
                            stroke="#ffffff"
                            strokeWidth="4.5"
